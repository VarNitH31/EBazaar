        ...
        <NavBar/>
              <div className="compprodcontainer">
                ...
                <div className="content">
                       <Link to="/1"> ASUS [SmartChoice] Vivobook 16X (2022), 16-inch (40.64 cms) WUXGA, AMD Ryzen 5 5600H, Thin and Light Laptop (8GB/512GB SSD/Integrated Graphics/Win 11/Office 2021/Quiet Blue/1.8 kg), M1603QA-MB502WS</Link>
         ...
         <div className="compprodcontainer">
                ...
                <div className="content">
                       <Link to="/asuszephurs.html"> ASUS ROG Zephyrus G14 Ultra Slim Gaming Laptop, 14" QHD Display(2560x1440) ,AMD Ryzen 9 5900HS ,NVIDIA GeForce RTX 3060,16GB RAM | 1TB PCIe SSD, Windows 10</Link>
